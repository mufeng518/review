...
<select name="名称" [multiple]>
    <option value="下拉列表框选项内容" [selected]>下拉列表选项框选项内容</option>
    ...
</select>
```
...
* 文本框
    ...
    ```html
    <input type="text" name="名称" vlaue="值" [placeholder="占位符"]/>
    ```

* 密码框

    ```html
    <input type="password" name="名称" vlaue="值" [placeholder="占位符"]/>
    ```
...
* 复选框
    ...
    ```html
    <input type="checkbox" name="名称" vlaue="多选内容" [checked]/>
    ```

* 普通按钮

    ```html
    <input type="button" name="按钮内容"/>
    ```

* 提交按钮

    ```html
    <input type="submit" name="按钮内容"/>
    ```

* 重置按钮

    ```html
    <input type="reset" name="按钮内容"/>
    ```

* 图像按钮

    ```html
    <input type="image" src="图像文件路径" alt="图像不显示时替代的文字" name="按钮内容"/>
    ```
...
* 隐藏域
    ...
    ```html
    <input type="hidden" name="按钮内容" value="值"/>
    ```
